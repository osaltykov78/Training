...
public class Oksana {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		List<String> dniText = null;
		List<String> tempText = null;

		
		for (WebElement e : dni) {
			dniText.add(e.getText());
		}
		for (WebElement e : temperature) {
			tempText.add(e.getText());
		}

		Stream<List<String>> dniStream = Stream.of(dniText);
